...
/**
 * Brazilian Portuguese language strings for block_saipa.
 *
 * @package    block_saipa
...
$string['chat_connect_error']     = 'Erro ao conectar com o SAIPA. Tente novamente, por favor.';
$string['chat_feedback_not_useful'] = 'Não útil';
$string['chat_feedback_useful']  = 'Útil';
$string['chat_loading']           = 'Pensando...';
$string['chat_placeholder']       = 'Pergunte qualquer coisa sobre este curso...';
$string['chat_send']              = 'Enviar';
$string['chat_title']             = 'Assistente SAIPA';
$string['index_button']           = 'Indexar curso';
$string['pluginname']             = 'Assistente SAIPA';
$string['privacy:no_data_reason'] = 'O bloco SAIPA não armazena dados pessoais por si mesmo. Os dados são gerenciados pelo local_saipa.';
$string['requires_local']         = 'O bloco Assistente SAIPA requer que local_saipa esteja instalado.';
