#!/usr/bin/env bash
# package.sh — Build a clean release ZIP for block_saipa.
#
# Usage:
#   ./package.sh          # reads version from version.php
#   ./package.sh 0.5.0    # override version label
#
# Output: ../block_saipa-<version>.zip  (one level up from the plugin dir)

set -euo pipefail

PLUGIN_DIR="$(cd "$(dirname "$0")" && pwd)"
PLUGIN_NAME="block_saipa"
